...
__all__ = ['TrainingSampler', 'RepeatFactorTrainingSampler', 'InferenceSampler']
...
class RepeatFactorTrainingSampler(Sampler):
    ...
    def repeat_factors_from_category_frequency(dataset_dicts, repeat_thresh):
        """Computes (fractional) per-image repeat factors based on category frequency.
    ...
    def _get_epoch_indices(self, generator):
        """Creates a list of dataset indices (with repeats) to use for one epoch.
