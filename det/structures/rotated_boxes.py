...
__all__ = ['RotatedBoxes', 'pairwise_iou_rotated']
...
class RotatedBoxes(Boxes):
    ...
    def __getitem__(self, item: Union[int, slice, torch.BoolTensor]) -> 'RotatedBoxes':
        ...
        b = self.tensor[item]
        assert b.dim(
        ) == 2, 'Indexing on RotatedBoxes with {} failed to return a matrix!'.format(item)
...
def pairwise_iou_rotated(boxes1: RotatedBoxes, boxes2: RotatedBoxes) -> None:
    """
