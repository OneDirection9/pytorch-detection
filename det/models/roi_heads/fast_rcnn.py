...
import torch
from foundation.nn import giou_loss, smooth_l1_loss
from torch import nn
from torch.nn import functional as F

from det.config import CfgNode
from det.layers import ShapeSpec, batched_nms, cat, nonzero_tuple
...
class FastRCNNOutputLayers(nn.Module):
    ...
    @classmethod
    def from_config(cls, cfg: CfgNode, input_shape: ShapeSpec) -> 'FastRCNNOutputLayers':
        return cls(
