...
from det.layers import Conv2d, ShapeSpec, cat, get_norm
...
def mask_rcnn_loss(pred_mask_logits, instances, vis_period=0):
    ...
    # false_positive = (mask_incorrect &
    #                   ~gt_masks_bool).sum().item() / max(gt_masks_bool.numel() - num_positive, 1.0)
...
class BaseMaskRCNNHead(nn.Module):
    ...
    def __init__(self, *, vis_period: int = 0) -> None:
        """
    ...
    @classmethod
    def from_config(cls, cfg: CfgNode, input_shape: ShapeSpec) -> 'BaseMaskRCNNHead':
        return cls(vis_period=cfg.VIS_PERIOD)
